...
num_start_samples=1;
num_total_samples=2999;
% to simulate data being read from disk / generated etc.


%data_disk=rand(5,5,1,num_total_samples); 
data_disk=h5read('hdf5_input', '/data', [1 1 1 num_start_samples], [256, 1, 1, num_total_samples]);
%label_disk=rand(10,num_total_samples); 
label_disk=h5read('hdf5_input', '/label', [1 num_start_samples], [1, num_total_samples]);
...
data_rd=h5read(filename, '/data', [1 1 1 1000], [256, 1, 1, 1000]);
